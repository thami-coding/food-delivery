...
export default function EmailSent({ email }: { email: string }) {
  ...
  return (
    <article className="ml-auto mr-auto mt-15 py-15 shadow-lg shadow-neutral-900 rounded-md text-white px-12 w-[28rem] bg-[#202020] ">
      ...
      <p className="mb-3 text-center text-neutral-300 px-10">
      ...
      <div className="mt-8">
        <button
          onClick={handleClick}
          disabled={isPending}
          className="w-full text-neutral-900 text-[1.2rem] py-3 rounded-md cursor-pointer hover:bg-amber-400 bg-amber-300"
        >
