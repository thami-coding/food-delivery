...
export default function ForgotPaswordPage() {
  ...
  const { mutate, isPending, isSuccess, isError, error, data } = useForgotPassword()
  ...
  return (
    <article className="ml-auto mr-auto mt-10 py-15  rounded-md text-neutral-50 px-8 w-[28rem] bg-[#202020] ">
      ...
      <p className='mb-3 text-center text-neutral-300'>Enter your email address and we will send you instructons to reset your password.</p>
      <form onSubmit={handleSubmit} className='mt-8'>
       ...
       <Link to="/" className='underline block mt-4 text-center capitalize hover:text-yellow-400'>Back home</Link>
      </form>
    </article>
  )
